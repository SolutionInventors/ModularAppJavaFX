...
public class StudentController implements Initializable{
	...
	@FXML private TextField	txtBoxIdno;
	@FXML private	TextField	txtBoxfirstname;
	@FXML	private	TextField	txtBoxlastname;
	@FXML	private	TextField	txtBoxdateRegistered;
	@FXML	private	TextField	txtBoxclassName;
	@FXML	private	TextField	txtBoxDob;
	@FXML	private	TextField	txtBoxphoneno;
	...
	public void getuser() {
		...
		txtBoxIdno.setText(String.valueOf(std.getId()));
		txtBoxfirstname.setText(std.getFirstName());
		txtBoxlastname.setText(std.getLastName());
